            ...
            <ScrollView contentContainerStyle={tw`p-4 pb-20`}>
                <View style={tw`mb-4 rounded-2xl bg-slate-900 p-5`}>
                    <View style={tw`flex-row items-center`}>
                        ...
                        <View style={tw`ml-3`}>
                            <Text style={tw`text-base font-bold text-white`}>Khach hang</Text>
                            <Text style={tw`text-xs text-slate-300`}>Thanh vien tieu chuan</Text>
                        </View>
                    </View>
                ...
                <TouchableOpacity style={tw`rounded-xl border border-red-200 bg-red-50 py-3`}>
