        ...
        <Popover open={open} onOpenChange={setOpen}>
            <PopoverTrigger asChild>
                <Button
                    ...
                    disabled={disabled}
                >
                    <CalendarDays className="mr-3 h-4 w-4 text-gray-400 flex-shrink-0" />
            ...
            <PopoverContent
                className="w-auto p-0 rounded-lg shadow-lg border border-gray-200 bg-white"
                align="start"
            >
                <div className="p-4 pb-2 flex items-center justify-between border-b border-gray-200">
                    <span className="text-sm font-semibold text-gray-900">Chọn ngày khởi hành</span>
                    <Button
                        variant="ghost"
                        size="sm"
                        className="h-8 text-xs font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-100 rounded-md transition-colors"
