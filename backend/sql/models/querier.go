...
type Querier interface {
	...
	CountBusTypes(ctx context.Context, q_ *string) (int64, error)
	CountBuses(ctx context.Context, arg CountBusesParams) (int64, error)
	CountBusesByProvider(ctx context.Context, arg CountBusesByProviderParams) (int64, error)
